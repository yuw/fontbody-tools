...
# version 0.2
# ruby afm2eps.rb AFM-file output-dir
#
...
10 setlinewidth
#{bound_left + 5} #{bound_depth + 5} moveto
0 #{bound_height - bound_depth - 10} rlineto #{bound_right - bound_left - 10} 0 rlineto
0 #{-bound_height + bound_depth + 10} rlineto closepath stroke
#{extra_bound_left} 5 moveto
#{extra_bound_right} 0 rlineto stroke
HEREDOC
  end
end
